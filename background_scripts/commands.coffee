...
defaultKeyMappings =
  ...
  "j":     "LinkHints.activateMode"
  "uj":     "LinkHints.activateModeToOpenInNewTab"
  "<a-q>": "LinkHints.activateModeWithQueue"
  "<a-l>": "LinkHints.activateModeToCopyLinkUrl"

  "<a-s>": "enterFindMode"
  "s": "performFind"
  "r": "performBackwardsFind"

  "[[": "goPrevious"
  "]]": "goNext"

  "<a-w>": "copyCurrentUrl"
  "y": "openCopiedUrlInCurrentTab"
  "uy": "openCopiedUrlInNewTab"
  ...
  "u<a-t>": "Vomnibar.activate"
  "<a-t>": "Vomnibar.activateInNewTab"

  "<a-j>": "Vomnibar.activateTabSelection"

  "u<a-o>": "Vomnibar.activateBookmarks"
  "<a-o>": "Vomnibar.activateBookmarksInNewTab"
